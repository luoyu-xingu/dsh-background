		...
		class BackgroundClient {
			...
			adopt(section) {
				...
				if (path === "") {
					...
					this.ensureStyleEl();
					this.styleEl.textContent = buildBackgroundCss(`/dsh-background/image?v=${this.rev}`, veil);
					document.documentElement.setAttribute("data-dsh-background", "");
				}
				return { path, veil, rev: this.rev };
			}
									...
									(0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											(0, react_jsx_runtime.jsx)("input", {
												...
												onChange: (e) => changeVeil(e.target.value)
											}),
											(0, react_jsx_runtime.jsx)("span", {
